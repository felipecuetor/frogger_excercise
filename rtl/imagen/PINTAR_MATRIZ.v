...
generate
  for (x=0; x<8; x=x+1) 
  begin : PosY6
   assign PINTAR_6_OUT[x]= (PINTAR_VEHICULOS_6_IN[x]&PINTAR_RANA_6_IN[x] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[0] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[1] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[2])
				| PINTAR_DATA_6[x];
  end
endgenerate
...
generate
  for (x=0; x<8; x=x+1) 
  begin : PosY5
   assign PINTAR_5_OUT[x]= (PINTAR_VEHICULOS_5_IN[x] & PINTAR_RANA_5_IN[x] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[0] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[1] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[2])
				| PINTAR_DATA_5[x];
  end
endgenerate
...
generate
  for (x=0; x<8; x=x+1) 
  begin : PosY4
   assign PINTAR_4_OUT[x]= (PINTAR_VEHICULOS_4_IN[x] &PINTAR_RANA_4_IN[x] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[0] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[1] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[2])
				| PINTAR_DATA_4[x];
  end
endgenerate
...
generate
  for (x=0; x<8; x=x+1) 
  begin : PosY3
     assign PINTAR_3_OUT[x]= (PINTAR_VEHICULOS_3_IN[x] & PINTAR_RANA_3_IN[x] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[0] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[1] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[2])
				| PINTAR_DATA_3[x];
  end
endgenerate
...
generate
  for (x=0; x<8; x=x+1) 
  begin : PosY2
   assign PINTAR_2_OUT[x]= (PINTAR_VEHICULOS_2_IN[x]&PINTAR_RANA_2_IN[x] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[0] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[1] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[2])
				| PINTAR_DATA_2[x];
  end
endgenerate
...
generate
  for (x=0; x<8; x=x+1) 
  begin : PosY1
   assign PINTAR_1_OUT[x]= (PINTAR_VEHICULOS_1_IN[x]& & PINTAR_RANA_1_IN[x] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[0] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[1] & PINTAR_MENU_PRINCIPAL_ESTADO_IN[2])
				| PINTAR_DATA_1[x];
  end
endgenerate
